...
encompasses the behavior of all possible PRNGs. Actually, to be completely
precise here, I would have to *prove* that `squares64` does indeed generate
values in the interval $[0, \texttt{WORD_BOUND})$. Here I am saying that it is
obvious, which is a hand-waiving argument. Perhaps, I will show how to do that
